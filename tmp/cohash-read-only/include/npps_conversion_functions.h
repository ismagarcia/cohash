...
//NppStatus 
//nppsConvert_24u32u(const Npp8u * pSrc, Npp32u * pDst, int nLength);
//
//NppStatus 
//nppsConvert_24u32f(const Npp8u * pSrc, Npp32f * pDst, int nLength);
//
//NppStatus 
//nppsConvert_32u24u_Sfs(const Npp32u * pSrc, Npp8u * pDst, int nLength, int nScaleFactor);
//
//NppStatus 
//nppsConvert_32f24u_Sfs(const Npp32f * pSrc, Npp8u * pDst, int nLength, int nScaleFactor);
//
//NppStatus 
//nppsConvert_24s32s(const Npp8u * pSrc, Npp32s * pDst, int nLength);
//
//NppStatus 
//nppsConvert_24s32f(const Npp8u * pSrc, Npp32f * pDst, int nLength);
//
//NppStatus 
//nppsConvert_32s24s_Sfs(const Npp32s * pSrc, Npp8u * pDst, int nLength, int nScaleFactor);
//
//NppStatus 
//nppsConvert_32f24s_Sfs(const Npp32f * pSrc, Npp8u * pDst, int nLength, int nScaleFactor);
//
//NppStatus 
//nppsConvert_16s16f(const Npp16s * pSrc, Npp16f * pDst, int nLength, NppRoundMode eRoundMode);
//
//NppStatus 
//nppsConvert_32f16f(const Npp32f * pSrc, Npp16f * pDst, int nLength, NppRoundMode eRoundMode);
//
//NppStatus 
//nppsConvert_16f16s_Sfs(const Npp16f * pSrc, Npp16s * pDst, int nLength, NppRoundMode eRoundMode, int nScaleFactor);
//
//NppStatus 
//nppsConvert_16f32f(const Npp16f * pSrc, Npp32f * pDst, int nLength);
