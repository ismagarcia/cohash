...
struct opencl_device_space_tag : device_space_tag {};
struct omp_device_space_tag : device_space_tag {};

#if   THRUST_DEVICE_BACKEND == THRUST_DEVICE_BACKEND_CUDA
typedef cuda_device_space_tag default_device_space_tag;
#elif THRUST_DEVICE_BACKEND == THRUST_DEVICE_BACKEND_OPENCL
typedef opencl_device_space_tag default_device_space_tag;
