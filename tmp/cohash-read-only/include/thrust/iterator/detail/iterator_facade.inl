...
// this is the function for opencl device space iterators
template<typename Traversal, typename ValueParam, typename Reference>
  struct iterator_facade_default_category_opencl_device :
    thrust::detail::eval_if<
      thrust::detail::and_<
        thrust::detail::is_device_reference<Reference>,
        thrust::detail::is_convertible<Traversal, thrust::forward_traversal_tag>
      ...
      thrust::detail::eval_if<
        thrust::detail::is_convertible<Traversal, thrust::random_access_traversal_tag>::value,
        thrust::detail::identity_<thrust::detail::random_access_opencl_device_iterator_tag>,
        thrust::detail::eval_if<
          thrust::detail::is_convertible<Traversal, thrust::bidirectional_traversal_tag>::value,
          thrust::detail::identity_<thrust::detail::bidirectional_opencl_device_iterator_tag>,
          thrust::detail::identity_<thrust::detail::forward_opencl_device_iterator_tag>
        >
      >,
      thrust::detail::eval_if<
        thrust::detail::and_<
          ...
          thrust::detail::is_convertible<Reference, ValueParam>
        >::value,
        thrust::detail::identity_<thrust::detail::input_opencl_device_iterator_tag>,
        thrust::detail::identity_<Traversal>
      >
    >
{
    ...
    : thrust::detail::eval_if<
        ...
        thrust::detail::eval_if<
          ...
          thrust::detail::eval_if<
            ...
            // check for opencl device space
            thrust::detail::eval_if<
              thrust::detail::is_convertible<Space, thrust::detail::opencl_device_space_tag>::value,
              iterator_facade_default_category_opencl_device<Traversal, ValueParam, Reference>,
