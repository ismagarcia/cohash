...
template<typename DeviceCategory>
  struct device_iterator_category_to_backend_space
    ...
    : eval_if<
        ...
        // convertible to opencl?
        eval_if<
          is_convertible<DeviceCategory, thrust::detail::opencl_device_iterator_tag>::value,

          detail::identity_<thrust::detail::opencl_device_space_tag>,
