...
//#include <thrust/detail/device/opencl/detail/stable_merge_sort.h>
//#include <thrust/detail/device/opencl/detail/stable_radix_sort.h>
...
/*
 *  This file implements the following dispatch procedure for opencl::stable_sort()
 *  and opencl::stable_sort_by_key().  All iterators are assumed to be "trivial
...
namespace third_dispatch
{
                                  ...
                                  thrust::detail::true_type)
    {
        ...
        //thrust::detail::raw_opencl_device_buffer<unsigned int> permutation(keys_last - keys_first);
        //thrust::sequence(permutation.begin(), permutation.end());
    
        //thrust::detail::device::opencl::detail::stable_merge_sort_by_key
        //    (keys_first, keys_last, permutation.begin(), comp);
   
        //RandomAccessIterator2 values_last = values_first + (keys_last - keys_first);
        //thrust::detail::raw_opencl_device_buffer<ValueType> temp(values_first, values_last);
...
namespace second_dispatch
{
                             ...
                             thrust::detail::true_type)
    {
        ...
        //thrust::detail::raw_opencl_device_buffer<unsigned int> permutation(last - first);
        //thrust::sequence(permutation.begin(), permutation.end());
    
        //thrust::detail::device::opencl::detail::stable_merge_sort
        //    (permutation.begin(), permutation.end(), indirect_comp<RandomAccessIterator,StrictWeakOrdering>(first, comp));
    
        //thrust::detail::raw_opencl_device_buffer<KeyType> temp(first, last);
                             ...
                             thrust::detail::false_type)
    {
        ...
        //thrust::detail::device::opencl::detail::stable_merge_sort(first, last, comp);
    }
                                  ...
                                  thrust::detail::true_type)
    {
        ...
        //thrust::detail::device::opencl::third_dispatch::stable_merge_sort_by_key
        ...
        //thrust::detail::raw_opencl_device_buffer<KeyType> temp(keys_first, keys_last);
...
namespace first_dispatch
{
    ...
    template<typename RandomAccessIterator,
      ...
      void stable_sort(RandomAccessIterator first,
                       ...
                       thrust::detail::true_type)
    {
        //// opencl path for thrust::stable_sort with primitive keys
        //// (e.g. int, float, short, etc.) and the default less<T> comparison
        //// method is implemented with stable_radix_sort_by_key
        //thrust::detail::device::opencl::detail::stable_radix_sort(first, last);
    }
                       ...
                       thrust::detail::false_type)
    {
        ...
        //thrust::detail::device::opencl::second_dispatch::stable_merge_sort
        //    (first, last, comp,
                              ...
                              thrust::detail::true_type)
    {
        ...
        //// (e.g. int, float, short, etc.) and the default less<T> comparison
        //// method is implemented with stable_radix_sort_by_key
        //thrust::detail::device::opencl::detail::stable_radix_sort_by_key(keys_first, keys_last, values_first);
    }
                              ...
                              thrust::detail::false_type)
    {
        ...
        //// device path for thrust::stable_sort with general keys 
        //// and comparison methods is implemented with stable_merge_sort
        //thrust::detail::device::opencl::second_dispatch::stable_merge_sort_by_key
        //    (keys_first, keys_last, values_first, comp,
        //        thrust::detail::integral_constant<bool, sort_keys_indirectly>());
    }
