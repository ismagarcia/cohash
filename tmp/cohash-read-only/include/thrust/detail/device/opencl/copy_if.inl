...
#include <thrust/detail/device/opencl/partition.h>
#include <thrust/detail/device/opencl/block/reduce.h>
#include <thrust/detail/device/opencl/block/inclusive_scan.h>
...
template <typename> class raw_opencl_device_buffer;
...
/*
    ...
    thrust::detail::device::opencl::block::reduce_n(shared_array, min(interval_end - interval_begin, IndexType(CTA_SIZE)), binary_op);
...
/*
    ...
    const IndexType max_intervals = 3 * (thrust::detail::device::opencl::arch::max_active_threads() / CTA_SIZE);  // TODO put this in a common place
    ...
    thrust::detail::raw_opencl_device_buffer<IndexType> block_results(num_intervals);
