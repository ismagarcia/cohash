...
#include <thrust/detail/device/opencl/copy_cross_space.h>
#include <thrust/detail/device/opencl/copy_device_to_device.h>
...
{
    return thrust::detail::device::opencl::copy_device_to_device(begin, end, result);
}
...
{
  return thrust::detail::device::opencl::copy_cross_space(first, last, result);
}
