...
#include <thrust/detail/device/opencl/sort.h>
                   ...
                   thrust::detail::opencl_device_space_tag)
{
    ...
    //thrust::detail::device::opencl::stable_sort(first, last, comp);
}
...
{
    // OpenCL implementation
    //thrust::detail::device::opencl::stable_sort_by_key(keys_first, keys_last, values_first, comp);
}
