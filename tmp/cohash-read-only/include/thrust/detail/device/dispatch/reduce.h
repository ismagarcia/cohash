                                                   ...
                                                   thrust::detail::opencl_device_space_tag)
{
  ...
  return thrust::detail::device::opencl::get_unordered_blocked_reduce_n_schedule(first, n, init, binary_op);
}
...
{
  // OpenCL implementation
  return thrust::detail::device::opencl::unordered_blocked_reduce_n(first, n, num_blocks, binary_op, result);
}
