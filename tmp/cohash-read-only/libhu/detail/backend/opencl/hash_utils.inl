...
#include <libhu/detail/backend/opencl/detail/hash_utils.h>
...
template<typename T_RAND_ACCESS_ITERATOR1,
  ...
  void access(T_RAND_ACCESS_ITERATOR1 search_keys_begin,
    ...
    {
      libhu::detail::backend::opencl::detail::access(search_keys_begin, search_keys_end, hash_table_begin, hash_table_end, output_values_begin, hf, constrained_hash_access, max_age);
    }
