...
#endif
#include <libhu/detail/backend/opencl/hash_utils.h>
#include <libhu/detail/backend/omp/hash_utils.h>
              ...
              thrust::detail::opencl_device_space_tag)
{
  ...
  libhu::detail::backend::opencl::access(keys.begin(), keys.end(), hash_table.begin(), hash_table.end(), output_values_begin, hf, constrained_hash_access, max_age);
