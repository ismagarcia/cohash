...
// ------------------------------------------------------------------
  ...
  __constant__ unsigned int offsets_kv_rand[16] = OFFSETS_TABLE_16;
...
__inline__ HOST DEVICE T_VALUE      GET_KEY_ATTACH_ID(T_HASH_TABLE k)                                            { return ((k) >> (KEY_TYPE_BITS)) & ATTACH_ID_TYPE_MASK; }
__inline__ HOST DEVICE T_HASH_TABLE PACK_KEY_POS(T_KEY p)                                                        { return ((p) & KEY_TYPE_MASK); }
__inline__ HOST DEVICE T_HASH_TABLE PACK_KEY_POS_AND_ATTACH_ID_AND_AGE(T_KEY p, T_ATTACH_ID i, T_AGE a)          { return T_HASH_TABLE(((T_HASH_TABLE(a) << (ATTACH_ID_TYPE_BITS + KEY_TYPE_BITS))) + ((T_HASH_TABLE(i) & ATTACH_ID_TYPE_MASK) << (KEY_TYPE_BITS)) + T_HASH_TABLE(p & KEY_TYPE_MASK)); }
__inline__ HOST DEVICE T_HASH_TABLE PACK_KEY_POS_AND_ATTACH_ID_AND_MAX_AGE(T_KEY p, T_ATTACH_ID i, T_MAX_AGE m)  { return T_HASH_TABLE(((T_HASH_TABLE(m) << (ATTACH_ID_TYPE_BITS + KEY_TYPE_BITS))) + ((T_HASH_TABLE(i) & ATTACH_ID_TYPE_MASK) << (KEY_TYPE_BITS)) + T_HASH_TABLE(p & KEY_TYPE_MASK)); }

// Hash function
__inline__ HOST DEVICE T_LOC h(T_KEY K, T_AGE AGE, libhu::U32 HSZ)
{
#if (ENABLE_HOST_COMPUTING)
  static unsigned int offsets_kv_rand[16] = OFFSETS_TABLE_16;
#endif

  return WRAP((K + (AGE + 1u) * (K * 101449u) + (offsets_kv_rand[AGE] * 679681u)), HSZ);
}
...
#if (ENABLE_GATOR)
  ANNOTATE_MARKER_COLOR_STR(ANNOTATE_BLUE, "rand_hash_build_insert_pre");
#endif
...
#if (ENABLE_GATOR)
  ANNOTATE_MARKER_COLOR_STR(ANNOTATE_BLUE, "rand_hash_build_insert_pos");
#endif
...
const libhu::U32 key_value_rand_hash_functor::DEFAULT_GROUP_SIZE            = 192u;

const libhu::U32 key_value_rand_hash_functor::KEY_TYPE_BITS                 = 32u;
const libhu::U32 key_value_rand_hash_functor::KEY_TYPE_MASK                 = libhu::U32( libhu::U64((1ull) << key_value_rand_hash_functor::KEY_TYPE_BITS) - 1ul );
const libhu::U32 key_value_rand_hash_functor::PACKED_KEY_TYPE_MASK          = libhu::U32( libhu::U64((1ull) << key_value_rand_hash_functor::KEY_TYPE_BITS) - 1ul );
const libhu::U32 key_value_rand_hash_functor::KEY_TYPE_RANGE                = libhu::U32( libhu::U64((1ull) << key_value_rand_hash_functor::KEY_TYPE_BITS) - 2ul );
const libhu::U32 key_value_rand_hash_functor::UNDEFINED_KEY                 = libhu::U32( libhu::U64((1ull) << key_value_rand_hash_functor::KEY_TYPE_BITS) - 1ul );
const libhu::U32 key_value_rand_hash_functor::PACKED_UNDEFINED_KEY          = libhu::U32( libhu::U64((1ull) << key_value_rand_hash_functor::KEY_TYPE_BITS) - 1ul );

const libhu::U32 key_value_rand_hash_functor::ATTACH_ID_TYPE_BITS           = 28u;
const libhu::U32 key_value_rand_hash_functor::ATTACH_ID_TYPE_MASK           = libhu::U32( libhu::U64((1ull) << key_value_rand_hash_functor::ATTACH_ID_TYPE_BITS) - 1ul );
const libhu::U32 key_value_rand_hash_functor::UNDEFINED_ATTACH_ID           = libhu::U32( libhu::U64((1ull) << key_value_rand_hash_functor::ATTACH_ID_TYPE_BITS) - 1ul );
const libhu::U32 key_value_rand_hash_functor::MAX_ATTACH_ID_TYPE            = libhu::U32( libhu::U64((1ull) << key_value_rand_hash_functor::ATTACH_ID_TYPE_BITS) - 2ul );

const libhu::U32 key_value_rand_hash_functor::KEY_TYPE_AGE_MASK             = 15u;
const libhu::U32 key_value_rand_hash_functor::KEY_TYPE_AGE_BITS             = 4u;
const libhu::U32 key_value_rand_hash_functor::INIT_KEY_TYPE_AGE             = 1u;
const libhu::U32 key_value_rand_hash_functor::KEY_TYPE_NULL_AGE             = 0u;
const libhu::U32 key_value_rand_hash_functor::KEY_TYPE_MAX_AGE              = 16u;
const libhu::U32 key_value_rand_hash_functor::KEY_TYPE_MAX_AGE_MASK         = 4u;
const libhu::U32 key_value_rand_hash_functor::KEY_TYPE_MAX_AGE_BITS         = 4u;

const libhu::U32 key_value_rand_hash_functor::HTABLE_ID                     = 0u;
