...
#endif
#include <libh/detail/backend/opencl/hash.h>
#include <libh/detail/backend/omp/hash.h>
...
template<typename T_RAND_ACCESS_ITERATOR1,
  ...
  void hash(T_RAND_ACCESS_ITERATOR1 keys_begin,
            ...
            bool                    constrained_hash_access,
            libhu::U32             &max_age,
            thrust::detail::opencl_device_space_tag)
{
  // ensure sequence has trivial iterators
  // XXX this prologue belongs somewhere else
  thrust::detail::trivial_sequence<T_RAND_ACCESS_ITERATOR1> keys(keys_begin, keys_end);
  ...
  libh::detail::backend::opencl::hash(keys.begin(), keys.end(), hash_table.begin(), hash_table.end(), hf, constrained_hash_access, max_age);
                   ...
                   thrust::detail::opencl_device_space_tag)
{
  ...
  libh::detail::backend::opencl::hash_by_key(keys.begin(), keys.end(), values.begin(), hash_table.begin(), hash_table.end(), hf, constrained_hash_access, max_age);
...
template<typename T_RAND_ACCESS_ITERATOR1,
  ...
  void hash_by_key(T_RAND_ACCESS_ITERATOR1 keys_begin,
                   ...
                   libhu::U32             &max_age)
{
  typedef typename thrust::iterator_space<T_RAND_ACCESS_ITERATOR1>::type IT_SPACE_T_RAND_ACCESS_ITERATOR1;
  typedef typename thrust::iterator_space<T_RAND_ACCESS_ITERATOR2>::type IT_SPACE_T_RAND_ACCESS_ITERATOR2;
  typedef typename thrust::iterator_space<T_RAND_ACCESS_ITERATOR3>::type IT_SPACE_T_RAND_ACCESS_ITERATOR3;
  ...
  libh::detail::backend::dispatch::hash_by_key(keys_begin, keys_end, values_begin, hash_table_begin, hash_table_end, hf, constrained_hash_access, max_age,
    typename thrust::detail::minimum_space<
      IT_SPACE_T_RAND_ACCESS_ITERATOR1,
      IT_SPACE_T_RAND_ACCESS_ITERATOR2
      >::type());
