...
#include <libh/detail/backend/omp/detail/hash.h>
...
template<typename T_RAND_ACCESS_ITERATOR1,
  ...
  void hash(T_RAND_ACCESS_ITERATOR1 keys_begin,
                   ...
                   libhu::U32             &max_age)
{
  libh::detail::backend::omp::detail::hash(keys_begin, keys_end, hash_table_begin, hash_table_end, hf, constrained_hash_access, max_age);
}
...
template<typename T_RAND_ACCESS_ITERATOR1,
  ...
  void hash_by_key(T_RAND_ACCESS_ITERATOR1 keys_begin,
                   ...
                   libhu::U32             &max_age)
{
  libh::detail::backend::omp::detail::hash_by_key(keys_begin, keys_end, values_begin, hash_table_begin, hash_table_end, hf, constrained_hash_access, max_age);
}
