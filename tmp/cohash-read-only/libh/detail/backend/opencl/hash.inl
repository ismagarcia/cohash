...
#include <libh/detail/backend/opencl/detail/hash.h>
...
namespace second_dispatch
{
                ...
                thrust::detail::true_type)
    {
      ...
      libh::detail::backend::opencl::detail::hash(keys_begin, keys_end, hash_table_begin, hash_table_end, hf, constrained_hash_access, max_age);
    ...
    void hash_by_key(T_RAND_ACCESS_ITERATOR1 keys_begin,
                     ...
                     thrust::detail::true_type)
    {
      libh::detail::backend::opencl::detail::hash_by_key(keys_begin, keys_end, values_begin, hash_table_begin, hash_table_end, hf, constrained_hash_access, max_age);
    }
